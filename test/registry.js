    ...
    describe("Registry", function () {
        ...
        it("override test", async function () {
            ...
            await truffleAssert.reverts(
                registry.setRoyaltyLookupAddress(mockManifold.address, mockManifold.address, { from: eip2981Deployer }),
                "Permission denied"
            );
        ...
        it("getRoyalty test", async function () {
            ...
            await truffleAssert.reverts(
                registry.setRoyaltyLookupAddress(mockFoundation.address, mockManifold.address, { from: defaultDeployer }),
                "Permission denied"
            );
